...
const external = ['react', 'react-dom', 'redux', 'react-redux', 'react-router', 'react-router-dom', 'styled-components', 'prop-types', 'admin-bro', // TODO remove next line in version 2.0, see comment in src/frontend/bundle-entry.jsx
'admin-bro/components', 'admin-bro/property-types', 'admin-bro/types', 'admin-bro/style', 'axios', 'recharts'];
const globals = {
  react: 'React',
  redux: 'Redux',
  axios: 'axios',
