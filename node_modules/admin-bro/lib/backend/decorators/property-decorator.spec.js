...
describe('PropertyDecorator', function () {
  ...
  describe('#label', function () {
    it('returns camelCased name', function () {
      ...
      (0, _chai.expect)(new _propertyDecorator.default(args).label()).to.equal('Normal Name');
    });
  });
  ...
  describe('#subProperties', function () {
    ...
    it('changes label of the nested property to what was given in PropertyOptions', function () {
      ...
      (0, _chai.expect)(subProperty.label()).to.eq(subPropertyLabel);
    });
  });
  describe('#toJSON', function () {
    it('returns JSON representation of a property', function () {
      (0, _chai.expect)(new _propertyDecorator.default(args).toJSON()).to.have.keys('isTitle', 'isId', 'position', 'isSortable', 'availableValues', 'name', 'label', 'type', 'reference', 'components', 'isDisabled', 'subProperties', 'isArray', 'custom');
    });
  });
  afterEach(function () {
