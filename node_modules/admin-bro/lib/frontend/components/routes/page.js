...
class Page extends _react.default.Component {
  ...
  render() {
    ...
    if (!currentPage) {
      ...
      }, _react.default.createElement("p", null, "Page:", _react.default.createElement("b", null, ` "${pageName}" `), "does not exist."));
    }
    ...
    if (!Component || !isClient) {
      ...
      }, _react.default.createElement("p", null, "You have to specify component which will render this Page"));
    }

    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_noticeWrapper.default, null, _react.default.createElement(_notice.default, null)), _react.default.createElement(_errorBoundary.default, null, _react.default.createElement(Component, null)));
  }
