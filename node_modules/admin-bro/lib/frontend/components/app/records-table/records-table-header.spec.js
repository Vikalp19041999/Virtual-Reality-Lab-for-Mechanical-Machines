...
describe('<RecordsTableHeader />', function () {
  it('renders columns for selected properties and actions', async function () {
    ...
    const {
      container
    } = (0, _reactTestingLibrary.render)(_react.default.createElement(_testContextProvider.default, null, _react.default.createElement("table", null, _react.default.createElement(_recordsTableHeader.default, {
      properties: [property],
      titleProperty: property,
      sortBy: this.sortBy,
      direction: this.direction
    }))));
    (0, _chai.expect)(container.getElementsByTagName('th')).to.have.lengthOf(2);
  });
});