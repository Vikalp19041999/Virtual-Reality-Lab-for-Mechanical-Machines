...
const renderSubject = props => {
  ...
  const renderResult = (0, _reactTestingLibrary.render)(_react.default.createElement(_testContextProvider.default, null, _react.default.createElement(_reactRedux.Provider, {
    store: (0, _store.default)({})
  }, _react.default.createElement(_recordsTable.default, _extends({}, props, {
    onSelect: onSelect,
...
describe('<RecordsTable />', function () {
  ...
  context('10 records are given with bulk delete and show actions', function () {
    ...
    it('renders title property as a link', function () {
      (0, _chai.expect)(container.querySelectorAll('td[data-property-name="name"] a')).to.have.lengthOf(10);
    });
    it('renders input checkbox for selecting many records', function () {
      (0, _chai.expect)(container.querySelectorAll('td:first-child input')).to.have.lengthOf(10);
    });
  });
});